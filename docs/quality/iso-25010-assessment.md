...
|---|---|---|---|---|
| Functional suitability | analysis engine and 58 passing tests | Observed | Control semantics remain intentionally basic | Golden-report and property tests |
...
| Security | threat model, secret scan, pinned Actions, evidence gate | Observed | External settings and runtime controls unverified | Code scanning and provider evidence refresh |
